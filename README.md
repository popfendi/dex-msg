...
### **A hook which allows users to send messages with swaps**

Add string data to messages which will be emitted with the swap. Pick these up on the front end to display custom swap messages with your charting system.

# Built with the v4-template
